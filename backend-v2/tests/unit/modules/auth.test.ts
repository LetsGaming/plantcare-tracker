...
import type { UserRepository } from '../../../src-v2/modules/auth/domain/User';
import {
  RegisterUseCase,
  LoginUseCase,
  GuestLoginUseCase,
...
} from '../../../src-v2/modules/auth/application/AuthUseCases';
import {
  ValidationError,
  UnauthorizedError,
  NotFoundError,
  ConflictError,
} from '../../../src-v2/core/errors';
import { sessionStore } from '../../../src-v2/core/middleware/auth';
