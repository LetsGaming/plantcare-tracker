/**
 * modules/components/infrastructure/SQLiteComponentRepository.ts
 *
 * V2 improvement preserved: single JOIN fetches all images in one query
...
export class SQLiteComponentRepository {
...
function groupRows(rows: ComponentRow[]): ComponentData[] {
